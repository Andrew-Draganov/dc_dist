...
if __name__ == '__main__':
    ...
    #  - Write section 5
    #  - Make diagram for page 1 or page 2 of paper that describes the distance measure
    #  - Make heatmap of distance in a dataset of Euclidean distance and our distance
